import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, ref, inject, h, Suspense, Fragment, createApp, provide, shallowReactive, computed, unref, watch, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, shallowRef, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file:///Users/muhammadali/Desktop/LoopOrigin/Projects/AuroraPad/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/muhammadali/Desktop/LoopOrigin/Projects/AuroraPad/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/muhammadali/Desktop/LoopOrigin/Projects/AuroraPad/node_modules/unctx/dist/index.mjs';
import { defu } from 'file:///Users/muhammadali/Desktop/LoopOrigin/Projects/AuroraPad/node_modules/defu/dist/defu.mjs';
import { parseURL as parseURL$1, encodePath as encodePath$1, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/muhammadali/Desktop/LoopOrigin/Projects/AuroraPad/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/muhammadali/Desktop/LoopOrigin/Projects/AuroraPad/node_modules/vue/server-renderer/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/muhammadali/Desktop/LoopOrigin/Projects/AuroraPad/node_modules/h3/dist/index.mjs';
...
function createRouterMatcher(routes2, globalOptions) {
  ...
  function resolve(location2, currentLocation) {
    ...
    if ("name" in location2 && location2.name) {
      ...
      {
        const invalidParams = Object.keys(location2.params || {}).filter((paramName) => !matcher2.keys.find((k) => k.name === paramName));
...
const _routes = [
  {
    name: "license",
    path: "/license",
    component: () => import('./license-Cvp0e0lo.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import('./privacy-CwdU4NP6.mjs')
  },
  {
    name: "terms",
    path: "/terms",
    component: () => import('./terms-DuoGHeFA.mjs')
  },
  {
    name: "usage",
    path: "/usage",
    component: () => import('./usage-2A15kMqh.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dl-YZ_FA.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BAdkoJIY.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DBMBnPMG.mjs'));
