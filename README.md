...
It takes the familiarity of tools like Notepad++ and combines it with a more current UI, an integrated terminal dock, built-in workflow skills, project search, session restore, and CI-managed desktop releases.
...
AuroraPad is licensed under the AuroraPad Non-Commercial License. See [LICENSE](/Users/muhammadali/Desktop/LoopOrigin/Projects/AuroraPad/LICENSE) for the full terms.
